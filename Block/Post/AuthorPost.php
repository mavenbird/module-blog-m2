 ...
 */
class AuthorPost extends \Mavenbird\Blog\Block\Listpost
{
    /**
    ...
    public function getStatusHtmlById($statusId)
    {
        ...
        switch ($statusId) {
            case '2':
                $html = '<div class="mb-post-status mb-post-disapproved">' . __($statusText) . '</div>';
                break;
            case '1':
                $html = '<div class="mb-post-status mb-post-approved">' . __($statusText) . '</div>';
                break;
            case '0':
            default:
                $html = '<div class="mb-post-status mb-post-pending">' . __($statusText) . '</div>';
                break;
        }
