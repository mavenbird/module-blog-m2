...
namespace Mavenbird\Blog\Block\Adminhtml\Comment\Edit\Tab;
...
/**
 * Class Comment
 * @package Mavenbird\Blog\Block\Adminhtml\Comment\Edit\Tab
 */
class Comment extends Generic implements TabInterface
{
    ...
    {
        $comment = $this->_coreRegistry->registry('mavenbird_blog_comment');
        ...
        $postText = '<a href="' . $this->getUrl('mavenbird_blog/post/edit', ['id' => $comment->getPostId()])
