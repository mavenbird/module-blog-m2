...
namespace Mavenbird\Blog\Block\Adminhtml\Comment;
...
/**
 * Class Edit
 * @package Mavenbird\Blog\Block\Adminhtml\Comment
 */
class Edit extends Container
{
    ...
    {
        /** @var Comment $comment */
        $comment = $this->coreRegistry->registry('mavenbird_blog_comment');
        if ($comment->getId()) {
