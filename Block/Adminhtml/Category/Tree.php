...
use Mavenbird\Blog\Model\ResourceModel\Category\Tree as BlogTreeResource;
...
class Tree extends \Magento\Catalog\Block\Adminhtml\Category\Tree
{
    ...
    {
        return $this->getUrl('mavenbird_blog/category/jsonTree');
    }
    ...
    {
        return $this->getUrl('mavenbird_blog/category/move');
    }
