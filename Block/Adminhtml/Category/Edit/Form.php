...
namespace Mavenbird\Blog\Block\Adminhtml\Category\Edit;
...
use Mavenbird\Blog\Model\Category as BlogCategory;
use Mavenbird\Blog\Model\CategoryFactory as BlogCategoryFactory;
use Mavenbird\Blog\Model\ResourceModel\Category\Tree as BlogResourceTree;

/**
 * Class Form
 * @package Mavenbird\Blog\Block\Adminhtml\Category\Edit
 */
class Form extends AbstractCategory
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($categoryId && $categoryId != 1 && !$this->getRequest()->getParam('duplicate')) {
            $this->addButton('delete', [
                ...
                'onclick' => "categoryDelete('" . $this->getUrl('mavenbird_blog/*/delete', ['_current' => true]) . "')",
                'class'   => 'delete'
            ]);
        }

        // Reset button
        $resetPath = $categoryId ? 'mavenbird_blog/*/edit' : 'mavenbird_blog/*/add';
    ...
    public function getSaveUrl(array $args = [])
    {
        ...
        return $this->getUrl('mavenbird_blog/*/save', $params);
    }
    ...
    {
        return $this->getUrl('mavenbird_blog/category/edit', ['_query' => false, 'id' => null, 'parent' => null]);
    }
    ...
    public function getDeleteUrl(array $args = [])
    {
        ...
        return $this->getUrl('mavenbird_blog/*/delete', $params);
    }
    ...
    public function getRefreshPathUrl(array $args = [])
    {
        ...
        return $this->getUrl('mavenbird_blog/*/refreshPath', $params);
    }
