...
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('mavenbird_blog_post_category')],
    ...
    /**
     * @return \Mavenbird\Blog\Model\Category
     */
    ...
    {
        return $this->getUrl('mavenbird_blog/category/posts', ['_current' => true]);
    }
