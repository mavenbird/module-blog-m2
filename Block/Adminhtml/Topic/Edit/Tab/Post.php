...
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('mavenbird_blog_post_topic')],
    ...
    /**
     * @return \Mavenbird\Blog\Model\Topic
     */
    public function getTopic()
    {
        return $this->coreRegistry->registry('mavenbird_blog_topic');
    }
    ...
    {
        return $this->getUrl('mavenbird_blog/topic/posts', ['_current' => true]);
    }
