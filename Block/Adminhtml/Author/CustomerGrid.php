 ...
 *
 * @category    Mavenbird
 * @package     Mavenbird_RewardPoints
 * @copyright   Copyright (c) Mavenbird (https://www.mavenbird.com/)
 * @license     https://www.mavenbird.com/LICENSE.txt
 */

namespace Mavenbird\Blog\Block\Adminhtml\Author;
...
/**
 * Class CustomerGrid
 * @package Mavenbird\Blog\Block\Adminhtml\Author
 */
class CustomerGrid extends Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['author' => $collection->getTable('mavenbird_blog_author')],
    ...
    {
        return $this->getUrl('mavenbird_blog/author/customergrid', ['_current' => true]);
    }
}
