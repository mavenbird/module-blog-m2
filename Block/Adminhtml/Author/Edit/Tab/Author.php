...
use Mavenbird\Blog\Block\Adminhtml\Renderer\Image;
use Mavenbird\Blog\Helper\Data;
use Mavenbird\Blog\Helper\Image as ImageHelper;
use Mavenbird\Blog\Model\Config\Source\AuthorStatus;

/**
 * Class Author
 * @package Mavenbird\Blog\Block\Adminhtml\Author\Edit\Tab
 */
class Author extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $author = $this->_coreRegistry->registry('mavenbird_blog_author');
    ...
    {
        return $this->getUrl('mavenbird_blog/author/customergrid');
    }
}
