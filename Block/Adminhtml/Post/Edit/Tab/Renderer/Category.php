...
namespace Mavenbird\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer;
...
use Mavenbird\Blog\Model\ResourceModel\Category\Collection;
use Mavenbird\Blog\Model\ResourceModel\Category\CollectionFactory as BlogCategoryCollectionFactory;
...
class Category extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Mavenbird_Blog::category');
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
                            ...
                            "blogCategory": {
                                ...
                                "children": {
                                    "blog_select_category": {
                                        "component": "Mavenbird_Blog/js/components/new-category",
                                        "config": {
                                            "filterOptions": true,
                                            "disableLabel": true,
                                            "chipsEnabled": true,
            ...
            $this->_urlBuilder->getUrl(
                ...
                ['handle' => 'mavenbird_blog_category_create', 'buttons' => 1]
            ) . '",
                                        "autoRender": false,
