...
use Mavenbird\Blog\Model\ResourceModel\Tag\Collection;
use Mavenbird\Blog\Model\ResourceModel\Tag\CollectionFactory as BlogTagCollectionFactory;
...
class Tag extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Mavenbird_Blog::tag');
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
            ...
            $this->_urlBuilder->getUrl(
                ...
                [
                    'handle' => 'mavenbird_blog_tag_create',
                    'buttons' => 1
                ]
            ) . '",
                                        "autoRender": false,
