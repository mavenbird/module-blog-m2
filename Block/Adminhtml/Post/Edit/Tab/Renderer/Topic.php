...
use Mavenbird\Blog\Model\ResourceModel\Topic\CollectionFactory as BlogTopicCollectionFactory;
...
class Topic extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Mavenbird_Blog::topic');
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
            ...
            $this->_urlBuilder->getUrl(
                ...
                [
                    'handle' => 'mavenbird_blog_topic_create',
                    'buttons' => 1
                ]
            ) . '",
                                        "autoRender": false,
