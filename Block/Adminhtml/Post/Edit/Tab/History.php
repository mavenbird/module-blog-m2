...
use Mavenbird\Blog\Model\ResourceModel\PostHistory\Collection;
...
class History extends Extended implements TabInterface
{
    ...
    /**
     * @var \Mavenbird\Blog\Helper\Data
     */
     ...
     * @param \Mavenbird\Blog\Helper\Data $_helperData
     * @param array $data
     */
    public function __construct(
        ...
        \Mavenbird\Blog\Helper\Data $_helperData,
        array $data = []
    ) {
    ...
    {
        return $this->getUrl('mavenbird_blog/post/history', ['_current' => true]);
    }
