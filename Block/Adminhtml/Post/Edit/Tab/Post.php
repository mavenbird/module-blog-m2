...
use Mavenbird\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Category;
use Mavenbird\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Tag;
use Mavenbird\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Topic;
...
class Post extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $post = $this->_coreRegistry->registry('mavenbird_blog_post');
        ...
        $fieldset->addField('image', \Mavenbird\Blog\Block\Adminhtml\Renderer\Image::class, [
            'name'  => 'image',
            'label' => __('Image'),
            'title' => __('Image'),
