...
class Edit extends Container
{
    ...
    protected function getUiSaveJs($action = null)
    {
        ...
        return "require(['uiRegistry'], function (registry) {"
            ...
            . "  if (!form) return;"
            . "  ['action','post[action]'].forEach(function(n){"
