...
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('mavenbird_blog_post_tag')],
    ...
    /**
     * @return \Mavenbird\Blog\Model\Tag
     */
    public function getTag()
    {
        return $this->coreRegistry->registry('mavenbird_blog_tag');
    }
    ...
    {
        return $this->getUrl('mavenbird_blog/tag/posts', ['_current' => true]);
    }
