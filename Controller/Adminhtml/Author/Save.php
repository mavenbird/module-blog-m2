    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('author')) {
            ...
            $this->_eventManager->dispatch(
                'mavenbird_blog_author_prepare_save',
            ...
            try {
                ...
                $this->_getSession()->setData('mavenbird_blog_author_data', false);

                if ($this->getRequest()->getParam('back')) {
                    $resultRedirect->setPath('mavenbird_blog/*/edit', ['id' => $author->getId(), '_current' => true]);
                } else {
            ...
            $this->_getSession()->setData('mavenbird_blog_author_data', $data);
