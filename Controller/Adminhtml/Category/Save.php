...
class Save extends Category
{
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('category')) {
            ...
            if (!$category) {
                $resultRedirect->setPath('mavenbird_blog/*/', ['_current' => true]);
            ...
            $this->_eventManager->dispatch(
                'mavenbird_blog_category_prepare_save',
            ...
            try {
                ...
                $this->_getSession()->setData('mavenbird_blog_category_data', false);
            } catch (Exception $e) {
                $this->messageManager->addErrorMessage($e->getMessage());
                $this->_getSession()->setData('mavenbird_blog_category_data', $data);
            }

            $resultRedirect->setPath('mavenbird_blog/*/edit', ['_current' => true, 'id' => $category->getId()]);

            return $resultRedirect;
        }

        $resultRedirect->setPath('mavenbird_blog/*/edit', ['_current' => true]);
