    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('topic')) {
            ...
            try {
                ...
                $this->_getSession()->setData('mavenbird_blog_topic_data', false);

                if ($this->getRequest()->getParam('back')) {
                    $resultRedirect->setPath('mavenbird_blog/*/edit', ['id' => $topic->getId(), '_current' => true]);
                } else {
            ...
            $this->_getSession()->setData('mavenbird_blog_topic_data', $data);
