...
class Category extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->categoryPostTable = $this->getTable('mavenbird_blog_post_category');
    }
    ...
    {
        $this->_init('mavenbird_blog_category', 'category_id');
    }
    ...
    protected function getMaxPosition($path)
    {
        ...
        $select        = $adapter->select()->from(
            $this->getTable('mavenbird_blog_category'),
            'MAX(' . $positionField . ')'
        )->where(
    ...
    public function savePostRelation(CategoryModel $category)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mavenbird_blog_category_change_posts',
