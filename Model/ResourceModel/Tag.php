...
class Tag extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->tagPostTable = $this->getTable('mavenbird_blog_post_tag');
    }
    ...
    {
        $this->_init('mavenbird_blog_tag', 'tag_id');
    }
    ...
    /**
     * @param \Mavenbird\Blog\Model\Tag $tag
     *
     * @return array
     */
    public function getPostsPosition(\Mavenbird\Blog\Model\Tag $tag)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Mavenbird\Blog\Model\Tag $tag)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mavenbird_blog_tag_change_posts',
