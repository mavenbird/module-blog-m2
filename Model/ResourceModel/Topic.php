...
class Topic extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->topicPostTable = $this->getTable('mavenbird_blog_post_topic');
    }
    ...
    {
        $this->_init('mavenbird_blog_topic', 'topic_id');
    }
    ...
    /**
     * @param \Mavenbird\Blog\Model\Topic $topic
     *
     * @return array
     */
    public function getPostsPosition(\Mavenbird\Blog\Model\Topic $topic)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Mavenbird\Blog\Model\Topic $topic)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mavenbird_blog_topic_change_posts',
