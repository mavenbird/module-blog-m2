...
namespace Mavenbird\Blog\Model\ResourceModel\Category;
...
use Mavenbird\Blog\Model\ResourceModel\Category;
use Mavenbird\Blog\Model\Category as CategoryModel;

/**
 * Class Tree
 * @package Mavenbird\Blog\Model\ResourceModel\Category
 */
class Tree extends Dbp
{
    ...
    public function __construct(
        ...
        parent::__construct(
            $coreResource->getConnection('mavenbird_blog_write'),
            $coreResource->getTableName('mavenbird_blog_category'),
            [
    ...
    public function initInactiveCategoryIds()
    {
        ...
        $this->eventManager->dispatch('mavenbird_blog_category_tree_init_inactive_category_ids', ['tree' => $this]);
