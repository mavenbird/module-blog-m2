...
class Post extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->postTagTable      = $this->getTable('mavenbird_blog_post_tag');
        $this->postTopicTable    = $this->getTable('mavenbird_blog_post_topic');
        $this->postCategoryTable = $this->getTable('mavenbird_blog_post_category');
        $this->postProductTable  = $this->getTable('mavenbird_blog_post_product');
        $this->postTrafficTable  = $this->getTable('mavenbird_blog_post_traffic');
        $this->postAuthorTable   = $this->getTable('mavenbird_blog_author');
    }
    ...
    {
        $this->_init('mavenbird_blog_post', 'post_id');
    }
    ...
    public function saveTagRelation(PostModel $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mavenbird_blog_post_change_tags',
    ...
    public function saveTopicRelation(PostModel $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mavenbird_blog_post_change_topics',
    ...
    public function saveCategoryRelation(PostModel $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mavenbird_blog_post_change_categories',
    ...
    public function saveProductRelation(PostModel $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'mavenbird_blog_post_change_products',
