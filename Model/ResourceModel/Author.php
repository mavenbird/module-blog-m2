...
class Author extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->postTable = $this->getTable('mavenbird_blog_post');
    }
    ...
    {
        $this->_init('mavenbird_blog_author', 'user_id');
    }
    ...
    /**
     * @param \Mavenbird\Blog\Model\Author $author
     *
     * @return array
     */
    public function getPostIds(\Mavenbird\Blog\Model\Author $author)
    {
