...
class Category extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'mavenbird_blog_category';
     ...
     * @var string
     */
    protected $_cacheTag = 'mavenbird_blog_category';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mavenbird_blog_category';
    ...
    public function getSelectedPostsCollection()
    {
        if (!$this->postCollection) {
            ...
            $collection->join(
                ['cat' => $this->getResource()->getTable('mavenbird_blog_post_category')],
