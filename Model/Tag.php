...
use Mavenbird\Blog\Model\ResourceModel\Tag\CollectionFactory as TagCollectionFactory;
...
class Tag extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'mavenbird_blog_tag';
     ...
     * @var string
     */
    protected $_cacheTag = 'mavenbird_blog_tag';
     ...
     * @var string
     */
    protected $_eventPrefix = 'mavenbird_blog_tag';
    ...
    public function getSelectedPostsCollection()
    {
        if ($this->postCollection === null) {
            ...
            $collection->join(
                ['post_tag' => $this->getResource()->getTable('mavenbird_blog_post_tag')],
