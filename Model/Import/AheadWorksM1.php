...
class AheadWorksM1 extends AbstractImport
{
    ...
    protected function _importPosts($data, $connection)
    {
        ...
        $this->_registry->register('mavenbird_import_post_tags_collection', $tags);
    ...
    protected function _importTags($data, $connection)
    {
        ...
        if ($isReplace && isset($sourceItems)) {
            ...
            $tags = $this->_registry->registry('mavenbird_import_post_tags_collection');
                ...
                foreach ($tagIds as $id) {
                    try {
                        ...
                        $this->_resourceConnection->getConnection()
                            ->insert(
                                $this->_resourceConnection->getTableName('mavenbird_blog_post_tag'),
    ...
    protected function _importCategories($data, $connection)
    {
        ...
        if ($isReplace && isset($sourceItems)) {
            ...
            $this->_importCategoryPost($data, $connection, $oldCategoryIds, 'mavenbird_blog_post_category');
        }
